...
printf "    | .___________________. |==|        ${blue}USER:${normal} $(echo $USER) %s\n"
printf "    | | ................. | |  |        ${blue}LAST LOGIN:${normal} $(uptime | awk '{print $1}') %s\n"
printf "    | | ::::: Apple ::::: | |  |        ${blue}LAST BOOT:${normal} $(uptime | cut -d',' -f 1 | cut -d 'p' -f 2-) %s\n"
printf "    | | ::::::::::::::::: | |  |        ${blue}DATE:${normal} $(date) %s\n"
printf "    | | ::::::::::::::::: | |  |        -------------------------%s\n"
printf "    | | ::::::::::::::::: | |  |        ${blue}HOSTNAME:${normal} $(hostname -f)%s\n"
printf "    | | ::::::::::::::::: | |  |        ${blue}IP ADDR:${normal} $(curl -s ifconfig.me) %s\n"
printf "    | | ::::::::::::::::: | |  |        ${blue}MODEL NAME:${normal} $(system_profiler SPSoftwareDataType SPHardwareDataType | grep "Model Name" | awk '{print $3 "\s "$4}') %s\n"
printf "    | !___________________! |()|        ${blue}KERNEL:${normal} $(uname -rms) %s\n"
printf "    !_______________________!__!        -------------------------%s\n"
printf "   /                            \       ${blue}TERMINAL:${normal} $(echo $TERM_PROGRAM) %s\n"
printf "  /  [][][][][][][][][][][][][]  \      ${blue}SHELL:${normal} $(echo $0) %s\n"
printf " /  [][][][][][][][][][][][][][]  \     $(top -l 1 -s 0 | grep 'Processes') %s\n"
printf "(  [][][][][____________][][][][]  )    $(top -l 1 -s 0 | grep 'CPU usage:') %s\n"
printf " \ ------------------------------ /     $(top -l 1 -s 0 | grep 'Networks:') %s\n"
